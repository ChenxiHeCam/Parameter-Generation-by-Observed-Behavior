...
\begin{table}[H]\centering\small
\caption{BAAIWorm$\to$modWorm soft-prior init-transfer, held-out behaviour distance to real OWMD ($N{=}16$ held-out starts, real Cook-ODE rollout). Lower is better. The prior beats the simulator's own default init on $13/16$ starts (one-sided Wilcoxon $p{=}0.025$).}
\begin{tabular}{lccc}\toprule
